package Algorithm.零散;

import java.util.Scanner;

/**
 * @description: Given an array，The problem is to find the maximum sum bitonic subarray.
 * A bitonic subarray is a subarray in which elements are first increasing and
 * then decreasing.（严格）
 *
 * A strictly increasing or strictly decreasing subarray
 * is also considered as bitonic subarray.
 *
